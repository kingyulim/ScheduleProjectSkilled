...
public enum ExceptionMessageEnum {
    ...
    MEMBER_FORBIDDEN(HttpStatus.FORBIDDEN, "해당 유저는 권한이 없습니다."),
    NOT_FOUND_SCHEDULE(HttpStatus.NOT_FOUND, "해당 스케줄을 찾을 수 없습니다."),
    NOT_FOUND_COMMENT(HttpStatus.NOT_FOUND, "댓글을 찾을 수 없습니다."),
    NOT_DELETE_SCHEDULE(HttpStatus.UNAUTHORIZED, "1개 이상의 댓글이 존재하여 삭제가 불가능 합니다."),
    NO_LOGIN(HttpStatus.UNAUTHORIZED, "로그인이 되지 않았습니다."),
    MEMBER_CHECK(HttpStatus.UNAUTHORIZED, "회원정보가 맞지 않습니다."),
    MEMBER_DELETE_CHECK(HttpStatus.UNAUTHORIZED, "탈퇴한 회원 입니다."),
